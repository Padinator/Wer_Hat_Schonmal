        ...
        nextMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (gameName.getText().toString().isEmpty())            // Check only if gameName is valid, creating starts later
                    Toast.makeText(NewGameOptions.this, "Dateiname darf nicht leer sein!", Toast.LENGTH_SHORT).show();
                else if (directory.exists())
                    Toast.makeText(NewGameOptions.this, "Dateiname darf nicht mehrfach verwendet werden!", Toast.LENGTH_SHORT).show();
                else if (playerNumber.isEmpty())
                        Toast.makeText(NewGameOptions.this, "Spielerzahlfeld darf nicht leer sein!", Toast.LENGTH_SHORT).show();
                else if (playerNumber.indexOf(".") != -1)
                    Toast.makeText(NewGameOptions.this, "Spielerzahl darf keinen Punkt enthalten!", Toast.LENGTH_SHORT).show();
                else if (storyMinNumber.indexOf(".") != -1)
                    Toast.makeText(NewGameOptions.this, "Mindest-Storyzahl darf keinen Punkt enthalten!", Toast.LENGTH_SHORT).show();
                else if (storyMaxNumber.indexOf(".") != -1)
                    Toast.makeText(NewGameOptions.this, "Maximale Storyzahl darf keinen Punkt enthalten!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(NewGameOptions.this, "Mindest-Storyzahl darf nur aus Zahlen bestehen!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(NewGameOptions.this, "Maximale Storyzahl darf nur aus Zahlen bestehen!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(NewGameOptions.this, "Spielerzahl darf nur aus Zahlen bestehen!", Toast.LENGTH_SHORT).show();
                else if (Integer.parseInt(playerNumber) < 2)
                    Toast.makeText(NewGameOptions.this, "Spielerzahl muss gr\u00f6\u00dfer als 2 sein!", Toast.LENGTH_SHORT).show();
                else if (Integer.parseInt(storyMinNumber) <= 0)          // Cast is valid, because of if-cases before
                    Toast.makeText(NewGameOptions.this, "Mindest-Storyzahl muss gr\u00f6\u00dfer 0 sein!", Toast.LENGTH_SHORT).show();
                else if (Integer.parseInt(storyMaxNumber) <= 0)          // Cast is valid, because of if-cases before
                    Toast.makeText(NewGameOptions.this, "Maximum-Storyzahl muss gr\u00f6\u00dfer 0 sein!", Toast.LENGTH_SHORT).show();
                else if (Integer.parseInt(storyMinNumber) > Integer.parseInt(storyMaxNumber))          // Casts are valid, because of if-cases before
                    Toast.makeText(NewGameOptions.this, "Minimum-Storyzahl muss kleiner oder gleich der Maximum-Storyzahl sein!", Toast.LENGTH_SHORT).show();
                else {
                     if (!playMode.isChecked()) {       // One phone for all player, only one counter:
                         Intent newGameOneDeviceIntent = new Intent(getApplicationContext(), NewGameOneDevice.class);
